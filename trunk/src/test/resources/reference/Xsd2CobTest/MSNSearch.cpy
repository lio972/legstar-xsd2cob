       01  R-Search.
         03  Request.
           ...
           05  Location.
             ...
             07  Radius COMP-2.
           05  Requests.
             07  SourceRequest OCCURS 0 TO 10.
               09  R-Source PIC X(32).
               09  Offset PIC S9(9) COMP-5.
               09  R-Count PIC S9(9) COMP-5.
               09  FileType PIC X(32).
               09  SortBy PIC X(32) OCCURS 1 TO 10.
               09  ResultFields PIC X(32) OCCURS 1 TO 10.
               09  SearchTagFilters.
                 11  R-string PIC X(32) OCCURS 0 TO 10.
       01  SearchResponse.
         03  Response.
           05  Responses.
             07  SourceResponse OCCURS 0 TO 10.
               09  R-Source PIC X(32).
               09  Offset PIC S9(9) COMP-5.
